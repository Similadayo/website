// Shape of the structured AI output
...
/** Runtime validation — returns error string or null if valid */
...
export const AI_RESPONSE_JSON_SCHEMA = {
  ...
  properties: {
    ...
    fit_reasons: {
      type: "string",
      description: "Explain why the company is a good fit for Brancr Labs (bullet points)",
    },
    gap_reasons: {
      type: "string",
      description: "Explain any gaps, blockers, or reasons it's NOT a perfect fit (bullet points)",
    },
    reason_not_fit: {
      type: ["string", "null"],
  ...
  required: [
    "fit_score", "confidence_score", "company_summary",
    "pain_points", "ai_use_cases", "best_outreach_angle",
    "fit_reasons", "gap_reasons", "reason_not_fit",
  ],
