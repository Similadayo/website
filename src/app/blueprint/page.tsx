      ...
      <header className="hero">
        <div className="container hero-grid">
          <div className="hero-copy">
            <p className="eyebrow">Product 01 · Diagnose</p>
            ...
            <div className="hero-cta">
              <Link href="/contact" className="btn btn-primary">Start a Blueprint <ArrowRight /></Link>
              <Link href="/sprint" className="btn btn-ghost">Then the Sprint</Link>
            </div>
          </div>
          <div className="hero-visual">
            <Pipeline
              title="Blueprint · five steps"
              badge="You own the output"
              nodes={[
                { label: "Current-state capture", meta: "01" },
                { label: "Failure-point analysis", meta: "02" },
                { label: "Prioritization", meta: "03" },
                { label: "Fix specification", meta: "04" },
                { label: "Honest verdict", meta: "05" },
              ]}
            />
          </div>
        </div>
      ...
      <section className="block">
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <details className="faq-item"><summary>What if we already know what&apos;s wrong?</summary><p>Your own diagnosis is a hypothesis to verify, not a scope to execute. Most workflows have a gap between the official process and the real one, and that gap is usually where the cost actually lives.</p></details>
        ...
        <div className="container">
          <Reveal>
            <div className="cta-panel">
              <h2>Start with a Workflow Blueprint™.</h2>
              <p>Diagnosis first, always. You&apos;ll know exactly what&apos;s worth fixing before anyone proposes a build.</p>
              <div className="hero-cta">
