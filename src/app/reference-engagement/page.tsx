...
import { ArrowRight, Transform } from "@/components/icons";
    ...
    <>
      ...
      <section className="block">
        <div className="container">
          ...
          <Reveal>
            <div className="beforeafter mt-lg">
              <div className="ba-col before">
                <h4>Before: manual</h4>
                <div className="ba-step">Payment</div>
                <div className="ba-step">Someone notices</div>
                <div className="ba-step">Re-type into 3 systems</div>
                <div className="ba-step">Chase the brief</div>
                <div className="ba-step">Kickoff (~40% forgotten)</div>
              </div>
              <div className="ba-transform" aria-hidden><Transform /></div>
              <div className="ba-col after">
                <h4>After: automated spine</h4>
                <div className="ba-step">Payment fires the sequence</div>
                <div className="ba-step">Single client record</div>
                <div className="ba-step">Self-serve brief + assets</div>
                <div className="ba-step">Auto project + assignment</div>
                <div className="ba-step">Kickoff booked, tracked</div>
              </div>
            </div>
          </Reveal>
        </div>
        ...
        <div className="container">
          ...
          <div className="card card-lg">
            ...
            <p className="prose mt-lg">
              Operational Health Score™, out of 100, scored on the same seven-dimension rubric for
      ...
      <section className="block">
        <div className="container">
          ...
          <div className="grid-4">
            ...
            <div className="card"><h3>Internal automation</h3><p>Auto-created client record, project, and designer assignment, with zero manual steps.</p></div>
        ...
        <div className="container">
          <Reveal>
            <div className="cta-panel">
              <h2>Want the same rigor applied to your workflow?</h2>
              <p>This is what a Blueprint and Sprint produce. Yours would start with the diagnosis.</p>
