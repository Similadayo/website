      ...
      <section className="block">
        <div className="narrow">
          ...
          <p className="prose mt-lg">
            ...
            We only build software for problems we&apos;ve personally solved, repeatedly, for
          ...
          <p className="prose mt-lg">
            ...
            And it&apos;s proof, if this works, that a research-driven firm built with no capital,
            no audience, and no network can win global customers on evidence alone.
          </p>
        </div>
      </section>
      ...
      <section className="block">
        <div className="container">
          <div className="cta-panel">
            <h2>See the method, or talk to us directly.</h2>
            <p>Everything here is downstream of one discipline: diagnose before you build.</p>
