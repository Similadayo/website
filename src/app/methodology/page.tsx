      ...
      <section className="block">
        <div className="container">
          ...
          <p className="prose">
            ...
            every day in coordination time, onboarding delay, and error — a cost that never
            appears as a line item, which is exactly why it survives so long unaddressed.
          </p>
          <p className="prose">
            It is almost always misdiagnosed. Felt as chaos, it looks like a people problem —
            hire a coordinator to hold the broken process together by hand. Felt as friction, it
            looks like a tooling problem — buy software to automate a process nobody has mapped.
      ...
      <section className="block tint">
        <div className="container">
          ...
          <p className="prose">
            ...
            specification — no second sales process. A Sprint has a name, a fixed timeline, a
      ...
      <section className="block tint">
        <div className="container">
          ...
          <p className="prose">
            ...
            patterns, templates, and lessons — filed, not lost — so the tenth engagement in a
            workflow domain costs roughly half what the first one did. This compounding, not
